          ...
          child: Column(
            ...
            children: [
              TopBar(this.widget.chat.title(),
                fontSize: 15,
                primaryAction: IconButton(icon: Icon(
                ...
                secondaryAction: IconButton(icon: Icon(
                  Icons.arrow_back, color: Color.fromRGBO(0, 82, 218, 1.0),
                ),
                  onPressed: () {
    ...
    if (_pageProvider.messages != null) {
      if (_pageProvider.messages!.length != 0) {
        ...
        return Align(alignment: Alignment.center,
          child: Text("Be the first one to say Hi!",
