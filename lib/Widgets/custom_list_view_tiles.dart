  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          !isOwnMessage?RoundedImageNetwork(key: GlobalKey(), imagePath: sender.imageURL, size: width*0.08):Container(),
          SizedBox(width: width*0.05,),
          message.type==MessageType.TEXT?
              TextMessageBubble(isOwnMessage: isOwnMessage, message: message, width: width, height:deviceHeight*0.06)
              :ImageMessageBubble(isOwnMessage: isOwnMessage, message: message, width: width*0.55, height: deviceHeight*0.30),
        ],
      ),
    );
  }
